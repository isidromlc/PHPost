                ...
                <div class="foto">
                    <div class="v_user">
                        <div class="avatar-box">
                            <a href="{$tsConfig.url}/perfil/{$tsFoto.user_name}"><img src="{$tsConfig.url}/files/avatar/{$tsFoto.f_user}_50.webp"/></a>
                        </div>
                        <div class="v_info">
                ...
                <div class="bajo" style="margin-top:5px">
                    <div class="comments">
                        ...
                        <div id="mensajes">
                            ...
                            <div class="item" id="div_cmnt_{$c.cid}">
                                <a href="{$tsConfig.url}/perfil/{$c.user_name}">
                                    <img src="{$tsConfig.url}/files/avatar/{$c.c_user}_50.webp" width="50" height="50" class="floatL"/>
                                </a>
                                <div class="firma">
                                    <div class="options">
                        ...
                        <div class="form">
                            <div class="avatar-box">
                                <img src="{$tsConfig.url}/files/avatar/{$tsUser->uid}_50.webp" width="50" height="50"/>
                            </div>
