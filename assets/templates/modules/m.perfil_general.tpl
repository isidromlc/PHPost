                        ...
                        <div class="widget w-posts clearfix">
                            ...
                            <ul class="ultimos">
                            	...
                            	<li class="categoriaPost" style="background-image:url({$tsConfig.tema}/images/icons/cat/{$p.c_img})">
                        ...
                        <div class="widget w-temas clearfix">
                            ...
                            <ul class="ultimos">
                                {foreach from=$tsGeneral.posts item=p}
                            	<li class="categoriaPost" style="background-image:url({$tsConfig.tema}/images/icons/cat/{$p.s_img})">
