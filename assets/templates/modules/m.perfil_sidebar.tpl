						...
						<div class="widget w-medallas clearfix">
							...
							<img src="{$tsConfig.tema}/images/icons/med/{$m.m_image}_16.png" class="qtip" title="{$m.m_title} - {$m.m_description}"/>
                                {/foreach}
            				</ul>
                        ...
                        <div class="widget w-seguidores clearfix">
            				...
            				<ul class="clearfix">
            					...
            					<li><a href="{$tsConfig.url}/perfil/{$s.user_name}" class="hovercard" uid="{$s.user_id}" style="display:inline-block;"><img src="{$tsConfig.url}/files/avatar/{$s.user_id}_50.webp" width="32" height="32"/></a></li>
                                {/foreach}
            				</ul>
						...
						<div class="widget w-visitas clearfix">
            				...
            				<ul class="clearfix">
            					...
            					<li><a href="{$tsConfig.url}/perfil/{$v.user_name}" class="hovercard" uid="{$v.user_id}" style="display:inline-block;"><img src="{$tsConfig.url}/files/avatar/{$v.user_id}_50.webp" class="vctip" title="{$v.date|hace:true}" width="32" height="32"/></a></li>
                                {/foreach}
            				</ul>
                            {else}
