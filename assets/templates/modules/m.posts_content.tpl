                	<div class="post-contenedor">
                    	...
                    	<div class="post-title">
							...
							<a class="fortuitare" href="{$tsConfig.url}/posts/fortuitae"><img class="qtip" title="Post aleatorio" src="{$tsConfig.tema}/images/arrow-join.png"/></a>
                        ...
                        {foreach from=$tsPost.puntos item=p}
                             ...
                             <a href="{$tsConfig.url}/perfil/{$p.user_name}" style="display:inline-block;"><img src="{$tsConfig.url}/files/avatar/{$p.user_id}_50.webp" class="vctip" title="{$p.user_name} ha dejado {$p.cant} puntos" width="32" height="32"/></a>
