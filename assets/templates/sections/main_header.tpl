...
<title>{$tsTitle}</title>
<link href="{$tsConfig.tema}/estilo.css" rel="stylesheet" type="text/css" />
<link href="{$tsConfig.tema}/phpost.css" rel="stylesheet" type="text/css" />
<link href="{$tsConfig.tema}/extras.css" rel="stylesheet" type="text/css" />
...
<link href="{$tsConfig.tema}/css/moderacion.css" rel="stylesheet" type="text/css" />
...
<div id="loading" style="display:none"><img src="{$tsConfig.tema}/images/ajax-loader.gif" alt="Cargando"> Procesando...</div>
<div id="swf"></div>
