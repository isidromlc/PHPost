            ...
            <div id="showResult">
                <table class="linksList">
                    ...
                    <tr id="div_{$r.post_id}">
                        <td title="{$r.c_nombre}" style="background:url({$tsConfig.tema}/images/icons/cat/{$r.c_img}) no-repeat center center;">&nbsp;</td>
                        <td style="text-align: left;">
                            ...
                            <div class="info" style="background-color:#FFF">
                                <img alt="Creado hace" src="{$tsConfig.tema}/images/icons/clock.png"/> <strong>{$r.post_date|hace:true}</strong> -
                                <img alt="Posts relacionados" src="{$tsConfig.tema}/images/icons/relacionados.png"/> <a href="{$tsConfig.url}/buscador/?q={$r.post_title}&e={$tsEngine}&cat={$tsCategory}&autor={$tsAutor}">Post Relacionados</a> -
                                <img alt="Creado por" src="{$tsConfig.tema}/images/icons/autor.png"/> <a href="{$tsConfig.url}/perfil/{$r.user_name}">{$r.user_name}</a> |
                                <img alt="0 puntos" src="{$tsConfig.tema}/images/icons/puntos.png"/> Puntos <strong>{$r.post_puntos}</strong> -
                                <img alt="0 puntos" src="{$tsConfig.tema}/images/icons/favoritos.gif"/> <strong>{$r.post_favoritos}</strong> Favoritos -
                                <img alt="0 puntos" src="{$tsConfig.tema}/images/icons/comentarios.gif"/> <strong>{$r.post_comments}</strong> Comentarios
                            </div>
                        </td>
                    </tr>
                    {/foreach}
