								...
								<div class="comentario-post clearbeta">
									...
									<div class="avatar-box" style="z-index: 99;">
										...
										<a href="{$tsConfig.url}/perfil/{$c.user_name}">
											...
											<img width="48" height="48" title="Avatar de {$c.user_name} en {$tsConfig.titulo}" src="{$tsConfig.url}/files/avatar/{$c.c_user}_50.webp" class="avatar-48 lazy" style="position: relative; z-index: 1; display: inline;">
