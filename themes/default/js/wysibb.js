CURLANG = {
	...
	goear: "Canción de Goear",
	fullscreen: "Maximizar",
	removeFormat: "Eliminar formato",
	
	modal_link_title: "Insertar enlace",
	modal_link_text: "Texto enlazado",
	modal_link_url: "URL",
	modal_email_text: "Texto enlazado",
	modal_email_url: "Email",
	modal_link_tab1: "Insertar desde URL",
	
	modal_img_title: "Insertar imagen",
	modal_img_tab1: "Añadir desde URL",
	modal_img_tab2: "Subir imagen",
	modal_imgsrc_text: "URL de la imagen",
	modal_img_btn: "Elegir una imagen",
	add_attach: "Adjuntar archivo",
	
	modal_swf_text: "URL del SWF",
	modal_video_text: "URL del vídeo",
	modal_goear_text: "URL de la canción",
	...
	validation_err: "La información ingresada no es válida",
	error_onupload: "Ha ocurrido un error mientras se cargaban los archivos",
...
var wysi = { on: function() {}, off: function() {} };
...
//			direction:			"ltr",
			...
			allButtons: {
				...
				spoiler : {
					...
					buttonHTML: '<span class="newicon i-spoiler"></span>',
					transform : {
				...
				table: {
					...
					transform: {
						...
						'<table class="bbctab">{SELTEXT}</table>': '[table]{SELTEXT}[/table]'
					},
					skipRules: true
				},
				fontsize: {
				...
				justify: {
					...
					buttonHTML: '<span class="newicon i-justify"></span>',
					groupkey: 'align',
					transform: {
				...
				swf : {
					title: CURLANG.swf,
					buttonHTML: '<span class="newicon i-flash"></span>',
					modal: {
						title: CURLANG.swf,
						width: "500px",
						tabs: [
				...
				goear: {
					title: CURLANG.goear,
					buttonHTML: '<span class="newicon i-goear"></span>',
					modal: {
						title: CURLANG.goear,
						width: "600px",
						tabs: [
			...
			smileList: [
				// SMILES DEFAULT
				{title: "xd", img: '<img src="'+global_data.img+'/images/smiles/041.png">', bbcode:"xd"},
				{title: ":)", img: '<img src="'+global_data.img+'/images/smiles/001.png">', bbcode:":)"},
				{title: ":D", img: '<img src="'+global_data.img+'/images/smiles/002.png">', bbcode:":D"},
				{title: ";)", img: '<img src="'+global_data.img+'/images/smiles/003.gif">', bbcode:";)"},
				{title: ":O", img: '<img src="'+global_data.img+'/images/smiles/004.png">', bbcode:":O"},
				{title: "(H)", img: '<img src="'+global_data.img+'/images/smiles/006.png">', bbcode:"(H)"},
				{title: ":P", img: '<img src="'+global_data.img+'/images/smiles/104.png">', bbcode:":P"},
				{title: "8o|", img: '<img src="'+global_data.img+'/images/smiles/049.png">', bbcode:"8o|"},
				{title: ":S", img: '<img src="'+global_data.img+'/images/smiles/009.png">', bbcode:":S"},
				{title: ":$", img: '<img src="'+global_data.img+'/images/smiles/008.png">', bbcode:"_$"},
				{title: ":(", img: '<img src="'+global_data.img+'/images/smiles/010.png">', bbcode:":("},
				{title: ":'(", img: '<img src="'+global_data.img+'/images/smiles/011.gif">', bbcode:":'("},
				{title: ":|", img: '<img src="'+global_data.img+'/images/smiles/012.png">', bbcode:":|"},
				{title: "(6)", img: '<img src="'+global_data.img+'/images/smiles/013.png">', bbcode:"(6)"},
				{title: "8-|", img: '<img src="'+global_data.img+'/images/smiles/050.png">', bbcode:"8-|"},
				{title: ":-/", img: '<img src="'+global_data.img+'/images/smiles/083.png">', bbcode:":-/"},
				{title: "^o)", img: '<img src="'+global_data.img+'/images/smiles/051.png">', bbcode:"^o)"},
				{title: "(A)", img: '<img src="'+global_data.img+'/images/smiles/014.png">', bbcode:"(A)"},
				{title: ":[", img: '<img src="'+global_data.img+'/images/smiles/043.png">', bbcode:":["},
				{title: ":-#", img: '<img src="'+global_data.img+'/images/smiles/048.png">', bbcode:":-#"},
				{title: ":-*", img: '<img src="'+global_data.img+'/images/smiles/052.png">', bbcode:":-*"},
				{title: "+o(", img: '<img src="'+global_data.img+'/images/smiles/053.png">', bbcode:"+o("},
				{title: "(brb)", img: '<img src="'+global_data.img+'/images/smiles/066.gif">', bbcode:"(brb)"},
				{title: ":^)", img: '<img src="'+global_data.img+'/images/smiles/072.gif">', bbcode:":^)"},
				{title: "*-)", img: '<img src="'+global_data.img+'/images/smiles/073.gif">', bbcode:"*-)"},
				{title: "<o)", img: '<img src="'+global_data.img+'/images/smiles/075.gif">', bbcode:"<o)"},
				{title: "8-)", img: '<img src="'+global_data.img+'/images/smiles/076.gif">', bbcode:"|-)"},
				{title: "|-)", img: '<img src="'+global_data.img+'/images/smiles/078.gif">', bbcode:";-/"},
				{title: ";-/", img: '<img src="'+global_data.img+'/images/smiles/082.png">', bbcode:"(jk)"},
				{title: "(jk)", img: '<img src="'+global_data.img+'/images/smiles/084.png">', bbcode:"(j)"},
				{title: "(j)", img: '<img src="'+global_data.img+'/images/smiles/086.png">', bbcode:"(V)"},
				{title: "(V)", img: '<img src="'+global_data.img+'/images/smiles/087.png">', bbcode:"(lol)"},
				{title: "(lol)", img: '<img src="'+global_data.img+'/images/smiles/089.gif">', bbcode:"(xD)"},
				{title: "(xD)", img: '<img src="'+global_data.img+'/images/smiles/090.png">', bbcode:"(xD)"},
				{title: ":8)", img: '<img src="'+global_data.img+'/images/smiles/088.png">', bbcode:":8"},
				{title: "(ff)", img: '<img src="'+global_data.img+'/images/smiles/091.gif">', bbcode:"(ff)"},
				{title: "(fm)", img: '<img src="'+global_data.img+'/images/smiles/092.gif">', bbcode:"(fm)"},
				{title: ":'|", img: '<img src="'+global_data.img+'/images/smiles/093.gif">', bbcode:":'|"},
				{title: ":]", img: '<img src="'+global_data.img+'/images/smiles/094.gif">', bbcode:":]"},
				{title: ":}", img: '<img src="'+global_data.img+'/images/smiles/095.png">', bbcode:":}"},
				{title: "(BOO)", img: '<img src="'+global_data.img+'/images/smiles/096.png">', bbcode:"(BOO)"},
				{title: "*|", img: '<img src="'+global_data.img+'/images/smiles/097.gif">', bbcode:"*|"},
				{title: "*\\", img: '<img src="'+global_data.img+'/images/smiles/098.png">', bbcode:"*\\"},
				{title: "(wm)", img: '<img src="'+global_data.img+'/images/smiles/100.png">', bbcode:"(wm)"},
				{title: "(xo)", img: '<img src="'+global_data.img+'/images/smiles/101.gif">', bbcode:"(xo)"},
				{title: "(l)", img: '<img src="'+global_data.img+'/images/smiles/015.png">', bbcode:"(l)"},
				{title: "(u)", img: '<img src="'+global_data.img+'/images/smiles/016.png">', bbcode:"(u)"},
				{title: "(@)", img: '<img src="'+global_data.img+'/images/smiles/018.png">', bbcode:"(@)"},
				{title: "(&)", img: '<img src="'+global_data.img+'/images/smiles/019.png">', bbcode:"(&)"},
				{title: "(S)", img: '<img src="'+global_data.img+'/images/smiles/020.png">', bbcode:"(S)"},
				{title: "(*)", img: '<img src="'+global_data.img+'/images/smiles/021.png">', bbcode:"(*)"},
				{title: "(~)", img: '<img src="'+global_data.img+'/images/smiles/022.png">', bbcode:"(~)"},
				{title: "(8)", img: '<img src="'+global_data.img+'/images/smiles/023.png">', bbcode:"(8)"},
				{title: "(E)", img: '<img src="'+global_data.img+'/images/smiles/024.png">', bbcode:"(E)"},
				{title: "(F)", img: '<img src="'+global_data.img+'/images/smiles/025.png">', bbcode:"(F)"},
				{title: "(W)", img: '<img src="'+global_data.img+'/images/smiles/026.png">', bbcode:"(W)"},
				{title: "(O)", img: '<img src="'+global_data.img+'/images/smiles/027.gif">', bbcode:"(O)"},
				{title: "(K)", img: '<img src="'+global_data.img+'/images/smiles/028.png">', bbcode:"(K)"},
				{title: "(G)", img: '<img src="'+global_data.img+'/images/smiles/029.png">', bbcode:"(G)"},
				{title: "(^)", img: '<img src="'+global_data.img+'/images/smiles/030.png">', bbcode:"(^)"},
				{title: "(P)", img: '<img src="'+global_data.img+'/images/smiles/031.png">', bbcode:"(P)"},
				{title: "(I)", img: '<img src="'+global_data.img+'/images/smiles/032.png">', bbcode:"(I)"},
				{title: "(C)", img: '<img src="'+global_data.img+'/images/smiles/033.png">', bbcode:"(C)"},
				{title: "(T)", img: '<img src="'+global_data.img+'/images/smiles/034.png">', bbcode:"(T)"},
				{title: "({)", img: '<img src="'+global_data.img+'/images/smiles/035.png">', bbcode:"({)"},
				{title: "(})", img: '<img src="'+global_data.img+'/images/smiles/036.png">', bbcode:"(})"},
				{title: "(B)", img: '<img src="'+global_data.img+'/images/smiles/037.png">', bbcode:"(B)"},
				{title: "(D)", img: '<img src="'+global_data.img+'/images/smiles/038.png">', bbcode:"(D)"},
				{title: "(Z)", img: '<img src="'+global_data.img+'/images/smiles/039.png">', bbcode:"(Z)"},
				{title: "(X)", img: '<img src="'+global_data.img+'/images/smiles/040.png">', bbcode:"(X)"},
				{title: "(Y)", img: '<img src="'+global_data.img+'/images/smiles/041.png">', bbcode:"(Y)"},
				{title: "(N)", img: '<img src="'+global_data.img+'/images/smiles/042.png">', bbcode:"(N)"},
				{title: "(nnh)", img: '<img src="'+global_data.img+'/images/smiles/044.png">', bbcode:"(nnh)"},
				{title: "(#)", img: '<img src="'+global_data.img+'/images/smiles/046.png">', bbcode:"(#)"},
				{title: "(R)", img: '<img src="'+global_data.img+'/images/smiles/047.png">', bbcode:"(R)"},
				{title: "(sn)", img: '<img src="'+global_data.img+'/images/smiles/054.png">', bbcode:"(sn)"},
				{title: "(tu)", img: '<img src="'+global_data.img+'/images/smiles/055.png">', bbcode:"(tu)"},
				{title: "(pl)", img: '<img src="'+global_data.img+'/images/smiles/056.png">', bbcode:"(pl)"},
				{title: "(||)", img: '<img src="'+global_data.img+'/images/smiles/057.png">', bbcode:"(||)"},
				{title: "(pi)", img: '<img src="'+global_data.img+'/images/smiles/058.png">', bbcode:"(pi)"},
				{title: "(so)", img: '<img src="'+global_data.img+'/images/smiles/059.png">', bbcode:"(so)"},
				{title: "(au)", img: '<img src="'+global_data.img+'/images/smiles/060.png">', bbcode:"(au)"},
				{title: "(ap)", img: '<img src="'+global_data.img+'/images/smiles/061.png">', bbcode:"(ap)"},
				{title: "(um)", img: '<img src="'+global_data.img+'/images/smiles/062.png">', bbcode:"(um)"},
				{title: "(ip)", img: '<img src="'+global_data.img+'/images/smiles/063.png">', bbcode:"(ip)"},
				{title: "(co)", img: '<img src="'+global_data.img+'/images/smiles/064.png">', bbcode:"(co)"},
				{title: "(mp)", img: '<img src="'+global_data.img+'/images/smiles/065.png">', bbcode:"(mp)"},
				{title: "(st)", img: '<img src="'+global_data.img+'/images/smiles/067.png">', bbcode:"(st)"},
				{title: "(pu)", img: '<img src="'+global_data.img+'/images/smiles/102.png">', bbcode:"(pu)"},
				{title: "(yn)", img: '<img src="'+global_data.img+'/images/smiles/068.png">', bbcode:"(yn"},
				{title: "(h5)", img: '<img src="'+global_data.img+'/images/smiles/069.gif">', bbcode:"(h5)"},
				{title: "(mo)", img: '<img src="'+global_data.img+'/images/smiles/070.png">', bbcode:"(mo)"},
				{title: "(bah)", img: '<img src="'+global_data.img+'/images/smiles/071.png">', bbcode:"(bah)"},
				{title: "(li)", img: '<img src="'+global_data.img+'/images/smiles/074.gif">', bbcode:"(li)"},
				{title: "(wo)", img: '<img src="'+global_data.img+'/images/smiles/077.png">', bbcode:"(wo)"},
				{title: "'.'", img: '<img src="'+global_data.img+'/images/smiles/080.png">', bbcode:"'.'"},
				{title: "(bus)", img: '<img src="'+global_data.img+'/images/smiles/045.png">', bbcode:"(bus)"},
				{title: "*p*", img: '<img src="'+global_data.img+'/images/smiles/079.png">', bbcode:"*p*"},
				{title: "*s*", img: '<img src="'+global_data.img+'/images/smiles/085.png">', bbcode:"*s*"},
				{title: "(M)", img: '<img src="'+global_data.img+'/images/smiles/017.png">', bbcode:"(M)"},
				{title: "(xx)", img: '<img src="'+global_data.img+'/images/smiles/103.png">', bbcode:"(xx)"},
			],
	...
	$.wysibb.prototype = {
		...
		build: function() {
			...
			//this.$editor.append('<span class="powered">Powered by <a href="http://www.rcdesign.es" target="_blank">RC Design<a/></span>');
