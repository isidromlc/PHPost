                                ...
                                {if $tsSave}<div style="display: block;" class="mensajes ok">Configuraciones guardadas</div>{/if}
                                    ...
                                    <fieldset>
                                        ...
                                        <dl>
                                            ...
                                            <dd>
										     <label><input name="count_guests" type="radio" id="ai_count_guests" value="1" {if $tsConfig.c_count_guests == 1}checked="checked"{/if} class="radio"/>S&iacute;</label>                                              
										     <label><input name="count_guests" type="radio" id="ai_count_guests" value="0" {if $tsConfig.c_count_guests != 1}checked="checked"{/if} class="radio"/>No</label>
                                            </dd>
                                        </dl>
										...
										<dl>
                                            ...
                                            <dd>
										     <label><input name="hits_guest" type="radio" id="ai_hits_guest" value="1" {if $tsConfig.c_hits_guest == 1}checked="checked"{/if} class="radio"/>S&iacute;</label>                                              
										     <label><input name="hits_guest" type="radio" id="ai_hits_guest" value="0" {if $tsConfig.c_hits_guest != 1}checked="checked"{/if} class="radio"/>No</label>
                                            </dd>
                                        </dl>
										...
										<dl>
                                            ...
                                            <dd>
										      <label><input name="fotos_private" type="radio" id="ai_fotos_private" value="1" {if $tsConfig.c_fotos_private == 1}checked="checked"{/if} class="radio"/>S&iacute;</label>                                               
										      <label><input name="fotos_private" type="radio" id="ai_fotos_private" value="0" {if $tsConfig.c_fotos_private != 1}checked="checked"{/if} class="radio"/>No</label>                                            
                                            </dd>
                                        </dl>
										...
										<dl>
                                            ...
                                            <dd>
										      <label><input name="see_mod" type="radio" id="ai_see_mod" value="1" {if $tsConfig.c_see_mod == 1}checked="checked"{/if} class="radio"/>S&iacute;</label>                                               
										      <label><input name="see_mod" type="radio" id="ai_see_mod" value="0" {if $tsConfig.c_see_mod != 1}checked="checked"{/if} class="radio"/>No</label>                                            
                                            </dd>
                                        </dl>
										...
										<dl>
                                            ...
                                            <dd>
                                                <label><input name="keep_points" type="radio" id="ai_keep_points" value="1" {if $tsConfig.c_keep_points == 1}checked="checked"{/if} class="radio"/>S&iacute;</label>
                                                <label><input name="keep_points" type="radio" id="ai_keep_points" value="0" {if $tsConfig.c_keep_points != 1}checked="checked"{/if} class="radio"/>No</label>
                                            </dd>
                                        </dl>
                                        <dl>
