...
<div id="res" class="boxy-content">
    ...
    <form action="" method="post" autocomplete="off">
        <fieldset>
            ...
            <dl>
               <dt><label for="providers">Proveedores de Email</label><span>Para agregar más solo debes agregar el proveedor ej: gmail.com, otro.ml, etc</span></dt>
               <dd><input type="text" name="providers" id="providers" placeholder="Agregue los proveedores que desea permitir" value="{$tsConfig.providers}"></dd>
            </dl>
            <hr />
            <dl>
                <dt>
