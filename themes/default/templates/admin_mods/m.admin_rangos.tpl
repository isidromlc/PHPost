         ...
         <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="400" align="center">
            ...
            <tbody>
               {foreach from=$tsRangos.regular item=r}
                  <tr>
                     <td><a href="{$tsConfig.url}/admin/rangos?act=list&rid={$r.id}&t=r" style="color:#{$r.color}">{$r.name}</a></td>
                     <td>{$r.num_members}</td>
                     <td>{$r.user_puntos}</td>
							<td>{$r.max_points}</td>
            ...
            <tfoot>
               <td colspan="5" style="text-align:right">
                  <a href="{$tsConfig.url}/admin/rangos?act=nuevo&t=s">Agregar nuevo rango &raquo;</a>
               </td>
            </tfoot>
         </table>
      </div>
         ...
         <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="550" align="center">
            ...
            <tbody>
               {foreach from=$tsRangos.post item=r}
                  <tr>
                     <td><a href="{$tsConfig.url}/admin/rangos?act=list&rid={$r.id}&t=p" style="color:#{$r.color}">{$r.name}</a></td>
                     <td>{$r.num_members}</td>
            ...
            <tfoot>
               <td colspan="7" style="text-align:right">
                  <a href="{$tsConfig.url}/admin/rangos?act=nuevo">Agregar nuevo rango &raquo;</a>
               </td>
            </tfoot>
         </table>
      </div>
         ...
         <fieldset>
            ...
            <div id="tab1">
               ...
               <dl>
                  ...
                  <dd><input type="color" id="rColor" name="rColor" value="{if empty($tsRango.r_color)}#000000{else}{$tsRango.r_color}{/if}" style="font-weight:bold;width:30%"/></dd>
               </dl>
					<dl>
