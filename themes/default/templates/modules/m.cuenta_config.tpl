<div class="content-tabs privacidad" style="display:none">
	<fieldset>
		...
		<div class="field">
			...
			<div class="input-fake">
				<select name="muro" class="cuenta-save-4">
		...
		<div class="field">
			...
			<div class="input-fake">
				<select name="muro_firm" class="cuenta-save-4">
					{foreach from=$tsPrivacidad item=p key=i}
		...
		<div class="field">
			...
			<div class="input-fake">
				<select name="last_hits" class="cuenta-save-4">
					{foreach from=$tsPrivacidad item=p key=i}
		...
		{if !$tsUser->is_admod}
			{if $tsPerfil.p_configs.rmp != 8}
				<div class="field">
					...
					<div class="input-fake">
						<select name="rec_mps" class="cuenta-save-4">
							{foreach from=$tsPrivacidad item=p key=i}
	...
	{/if}
	<div class="buttons">
		<input type="button" value="Guardar" onclick="cuenta.save(4)" class="mBtn btnOk">
	</div>
