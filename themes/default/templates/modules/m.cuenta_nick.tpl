<div class="content-tabs cambiar-nick">
   <fieldset>
		{if $tsUser->info.user_name_changes > 0}
         <p>Hola {$tsUser->nick}, le recordamos que dispone de {$tsUser->info.user_name_changes} cambios este a&ntilde;o.<br>Recuerde que si su cambio no es aprobado, no se le devolver&aacute; la disponibilidad de otro cambio.</p>
         <div class="field">
