      ...
      <div class="alert-cuenta cuenta-5"></div>
		{if $tsUser->info.user_name_changes > 0}
         ...
         <div class="field">
            ...
            <input type="text" value="{$tsUser->nick}" maxlength="15" name="new_nick" id="new_nick" class="text cuenta-save-5"/>
         </div>
		    <div class="field">
            <label for="password">Contrase&ntilde;a actual:</label>
            <input type="password" maxlength="32" name="password" id="password" class="text cuenta-save-5"/>
         </div>
         <div class="field">
            ...
            <input type="text" style="display: none" value="{$tsUser->info.user_email}" maxlength="35" name="pemail" id="pemail" class="text cuenta-save-5 input-hidden-pemail">
        </div>
      </fieldset>
    <div class="buttons">
